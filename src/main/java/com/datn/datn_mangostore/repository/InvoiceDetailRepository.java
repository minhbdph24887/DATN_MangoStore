...
public interface InvoiceDetailRepository extends JpaRepository<InvoiceDetail, Long> {
    ...
    @Query(value = "select top(3)\n" +
            ...
            "        where \n" +
            "        i.invoice_status = 5 \n" +
            "        and cast(i.invoice_payment_date as date) between :startDate and :endDate\n" +
            "        group by \n" +
            "        id.id_product_detail, \n" +
            "        p.name_product, \n" +
            "        s.name_size,\n" +
            ...
            "        img.images_file \n" +
            "        order by total_quantity desc", nativeQuery = true)
    List<Object[]> findTopSellingProductWithStartAndEndDate(@Param("startDate") LocalDate startDate,
